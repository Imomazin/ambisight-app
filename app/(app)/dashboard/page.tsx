  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-8 animate-fade-in">
        <h1 className="text-h1 text-text-main">Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 animate-slide-up">
        <StatCard
          ...
          value={72}
          trend={{ value: "+5.2%", direction: "up", label: "vs last period" }}
          sparkline={[45, 52, 48, 65, 59, 72, 70, 72]}
          variant="primary"
          icon={
        ...
        />
        <StatCard
          title="Exploitation Score"
          value={68}
          trend={{ value: "-2.1%", direction: "down", label: "vs last period" }}
          sparkline={[70, 72, 69, 71, 68, 65, 67, 68]}
          variant="purple"
          icon={
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <StatCard
          title="Balance Index"
          value="0.94"
          trend={{ value: "0.0%", direction: "neutral", label: "vs last period" }}
          sparkline={[92, 93, 94, 93, 95, 94, 94, 94]}
          variant="teal"
          icon={
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <StatCard
          ...
          sparkline={[73, 75, 78, 76, 80, 82, 83, 85]}
          variant="amber"
          icon={
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
